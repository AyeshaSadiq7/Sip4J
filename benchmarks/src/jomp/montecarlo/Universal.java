...
public class Universal {
  ...
  @Perm(requires="pure(DEBUG) in ALIVE", 
		  ensures= "pure(DEBUG) in ALIVE")*/
 ...
 @Perm(requires="share(DEBUG) * pure(#0) in ALIVE", /
 ensures= "share(DEBUG) * pure(#0) in ALIVE") pure should be share*/
  ...
  /**
    ...
    * @return Value of instance variable <code>UNIVERSAL_DEBUG</code>.
    @Perm(requires="pure(UNIVERSAL_DEBUG) in ALIVE", 
     ensures= "pure(UNIVERSAL_DEBUG) in ALIVE")
    */
  ...
  /**
    ...
    *        variable <code>UNIVERSAL_DEBUG</code>.
    @Perm(requires="share(UNIVERSAL_DEBUG) in ALIVE", 
     ensures= "share(UNIVERSAL_DEBUG) in ALIVE")
    */
  ...
  /**
    ...
    * @return Value of instance variable <code>prompt</code>.
    @Perm(requires="pure(prompt) in ALIVE", 
     ensures= "pure(prompt) in ALIVE")
    */
  ...
  /**
   ...
   @Perm(requires="share(prompt) * pure(prompt)  in ALIVE", 
 ensures= "share(prompt) * pure(prompt) in ALIVE")
    */
  ...
  /**
    ...
    * @param s The debug message to print out, to PrintStream "out".
    @Perm(requires="pure(DEBUG) * pure(UNIVERSAL_DEBUG) * pure(prompt) in ALIVE", 
     ensures= "pure(DEBUG) * pure(UNIVERSAL_DEBUG) * pure(prompt) in ALIVE")
