...
// Problem with 2 invocation of same method, it does not pick members of both method calls
...
public void Do()
{
  ...
  cipheridea(plain1, crypt1, Z);     // Encrypt plain1. // 
  
  cipheridea(crypt1, plain2, DK);    // Decrypt.
...
//omp parallel for private(i1,i2,ik,x1,x2,x3,x4,t1,t2,r)
...
Ref-Var= cb.array_rows, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.datasizes, Pre-Permissions=none, Post Permissions=none
Ref-Var= cb.plain1, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.crypt1, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.plain2, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.userkey, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.Z, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.DK, Pre-Permissions=none, Post Permissions=unique
Ref-Var= crypt.IDEATest.datasizes, Pre-Permissions=none, Post Permissions=unique
Method Name = Do
Ref-Var= cb.plain1, Pre-Permissions=pure, Post Permissions=pure
Ref-Var= cb.crypt1, Pre-Permissions=share, Post Permissions=share
Ref-Var= cb.Z, Pre-Permissions=pure, Post Permissions=pure
Ref-Var= cb.plain2, Pre-Permissions=share, Post Permissions=share
Ref-Var= cb.DK, Pre-Permissions=pure, Post Permissions=pure
Method Name = cipher_idea
Ref-Var= cb.plain1, Pre-Permissions=pure, Post Permissions=pure
Ref-Var= cb.crypt1, Pre-Permissions=share, Post Permissions=share
Ref-Var= cb.plain2, Pre-Permissions=share, Post Permissions=share
Ref-Var= cb.Z, Pre-Permissions=pure, Post Permissions=pure
...
Ref-Var= cb.plain1, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.array_rows, Pre-Permissions=pure, Post Permissions=pure
Ref-Var= cb.crypt1, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.plain2, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.userkey, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.Z, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.DK, Pre-Permissions=none, Post Permissions=unique
Method Name = calcEncryptKey
Ref-Var= cb.Z, Pre-Permissions=share, Post Permissions=share
Ref-Var= cb.userkey, Pre-Permissions=pure, Post Permissions=pure
Method Name = calcDecryptKey
Ref-Var= cb.Z, Pre-Permissions=share, Post Permissions=share
Ref-Var= cb.DK, Pre-Permissions=share, Post Permissions=share
Method Name = inv
Method Name = mul
...
Ref-Var= cb.array_rows, Pre-Permissions=share, Post Permissions=share
Ref-Var= cb.datasizes, Pre-Permissions=immutable, Post Permissions=immutable
Ref-Var= cb.plain1, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.crypt1, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.plain2, Pre-Permissions=none, Post Permissions=unique
Ref-Var= cb.userkey, Pre-Permissions=none, Post Permissions=unique
...
Ref-Var= cb.array_rows, Pre-Permissions=pure, Post Permissions=pure
Ref-Var= cb.plain1, Pre-Permissions=pure, Post Permissions=pure
Ref-Var= cb.plain2, Pre-Permissions=pure, Post Permissions=pure
Ref-Var= cb.crypt1, Pre-Permissions=pure, Post Permissions=pure
...
Class Name = JGFCryptBenchSizeA
Method Name = main
none int cb.size >> unique int cb.size
none int cb.array_rows >> unique int cb.array_rows
none int[] cb.datasizes >> none int[] cb.datasizes
none byte[] cb.plain1 >> unique byte[] cb.plain1
none byte[] cb.crypt1 >> unique byte[] cb.crypt1
none byte[] cb.plain2 >> unique byte[] cb.plain2
none short[] cb.userkey >> unique short[] cb.userkey
none int[] cb.Z >> unique int[] cb.Z
none int[] cb.DK >> unique int[] cb.DK
none int[] crypt.IDEATest.datasizes >> unique int[] crypt.IDEATest.datasizes
Method Name = Do
pure byte[] cb.plain1 >> pure byte[] cb.plain1
share byte[] cb.crypt1 >> share byte[] cb.crypt1
pure int[] cb.Z >> pure int[] cb.Z
share byte[] cb.plain2 >> share byte[] cb.plain2
pure int[] cb.DK >> pure int[] cb.DK
Method Name = cipher_idea
pure byte[] cb.plain1 >> pure byte[] cb.plain1
share byte[] cb.crypt1 >> share byte[] cb.crypt1
share byte[] cb.plain2 >> share byte[] cb.plain2
...
Method Name = buildTestData
none byte[] cb.plain1 >> unique byte[] cb.plain1
pure int cb.array_rows >> pure int cb.array_rows
none byte[] cb.crypt1 >> unique byte[] cb.crypt1
none byte[] cb.plain2 >> unique byte[] cb.plain2
none short[] cb.userkey >> unique short[] cb.userkey
none int[] cb.Z >> unique int[] cb.Z
none int[] cb.DK >> unique int[] cb.DK
Method Name = calcEncryptKey
share int[] cb.Z >> share int[] cb.Z
pure short[] cb.userkey >> pure short[] cb.userkey
Method Name = calcDecryptKey
share int[] cb.Z >> share int[] cb.Z
share int[] cb.DK >> share int[] cb.DK
Method Name = inv
Method Name = mul
Method Name = freeTestData
none byte[] cb.plain1 >> unique byte[] cb.plain1
...
Method Name = printHeader
Method Name = JGFrun
share int cb.size >> share int cb.size
share int cb.array_rows >> share int cb.array_rows
immutable int[] cb.datasizes >> immutable int[] cb.datasizes
none byte[] cb.plain1 >> unique byte[] cb.plain1
none byte[] cb.crypt1 >> unique byte[] cb.crypt1
none byte[] cb.plain2 >> unique byte[] cb.plain2
none short[] cb.userkey >> unique short[] cb.userkey
...
share int cb.array_rows >> share int cb.array_rows
immutable int[] cb.datasizes >> immutable int[] cb.datasizes
pure int cb.size >> pure int cb.size
none byte[] cb.plain1 >> unique byte[] cb.plain1
none byte[] cb.crypt1 >> unique byte[] cb.crypt1
none byte[] cb.plain2 >> unique byte[] cb.plain2
none short[] cb.userkey >> unique short[] cb.userkey
...
pure int cb.array_rows >> pure int cb.array_rows
pure byte[] cb.plain1 >> pure byte[] cb.plain1
pure byte[] cb.plain2 >> pure byte[] cb.plain2
pure byte[] cb.crypt1 >> pure byte[] cb.crypt1
Method Name = JGFtidyup
none byte[] cb.plain1 >> unique byte[] cb.plain1
none byte[] cb.crypt1 >> unique byte[] cb.crypt1
none byte[] cb.plain2 >> unique byte[] cb.plain2
...
Class Name = JGFCryptBenchSizeA
Method Name = main
@Perm(requires="none(cb.size) * none(cb.array_rows) * none(cb.datasizes) * none(cb.plain1) * none(cb.crypt1) * none(cb.plain2) * none(cb.userkey) * none(cb.Z) * none(cb.DK) * none(crypt.IDEATest.datasizes) in ALIVE", ensures= "unique(cb.size) * unique(cb.array_rows) * none(cb.datasizes) * unique(cb.plain1) * unique(cb.crypt1) * unique(cb.plain2) * unique(cb.userkey) * unique(cb.Z) * unique(cb.DK) * unique(crypt.IDEATest.datasizes) in ALIVE")
Method Name = Do
@Perm(requires="pure(cb.plain1) * share(cb.crypt1) * pure(cb.Z) * share(cb.plain2) * pure(cb.DK) in ALIVE", ensures= "pure(cb.plain1) * share(cb.crypt1) * pure(cb.Z) * share(cb.plain2) * pure(cb.DK) in ALIVE")
Method Name = cipher_idea
@Perm(requires="pure(cb.plain1) * share(cb.crypt1) * share(cb.plain2) * pure(cb.Z) * pure(cb.DK) in ALIVE", ensures= "pure(cb.plain1) * share(cb.crypt1) * share(cb.plain2) * pure(cb.Z) * pure(cb.DK) in ALIVE")
Method Name = buildTestData
@Perm(requires="none(cb.plain1) * pure(cb.array_rows) * none(cb.crypt1) * none(cb.plain2) * none(cb.userkey) * none(cb.Z) * none(cb.DK) in ALIVE", ensures= "unique(cb.plain1) * pure(cb.array_rows) * unique(cb.crypt1) * unique(cb.plain2) * unique(cb.userkey) * unique(cb.Z) * unique(cb.DK) in ALIVE")
Method Name = calcEncryptKey
@Perm(requires="share(cb.Z) * pure(cb.userkey) in ALIVE", ensures= "share(cb.Z) * pure(cb.userkey) in ALIVE")
Method Name = calcDecryptKey
@Perm(requires="share(cb.Z) * share(cb.DK) in ALIVE", ensures= "share(cb.Z) * share(cb.DK) in ALIVE")
Method Name = inv
@Perm(requires=" in ALIVE", ensures= " in ALIVE")
Method Name = mul
@Perm(requires=" in ALIVE", ensures= " in ALIVE")
Method Name = freeTestData
@Perm(requires="none(cb.plain1) * none(cb.crypt1) * none(cb.plain2) * none(cb.userkey) * none(cb.Z) * none(cb.DK) in ALIVE", ensures= "unique(cb.plain1) * unique(cb.crypt1) * unique(cb.plain2) * unique(cb.userkey) * unique(cb.Z) * unique(cb.DK) in ALIVE")
Method Name = printHeader
@Perm(requires=" in ALIVE", ensures= " in ALIVE")
Method Name = JGFrun
@Perm(requires="share(cb.size) * share(cb.array_rows) * immutable(cb.datasizes) * none(cb.plain1) * none(cb.crypt1) * none(cb.plain2) * none(cb.userkey) * none(cb.Z) * none(cb.DK) in ALIVE", ensures= "share(cb.size) * share(cb.array_rows) * immutable(cb.datasizes) * unique(cb.plain1) * unique(cb.crypt1) * unique(cb.plain2) * unique(cb.userkey) * unique(cb.Z) * unique(cb.DK) in ALIVE")
Method Name = JGFsetsize
@Perm(requires="share(cb.size) in ALIVE", ensures= "share(cb.size) in ALIVE")
Method Name = JGFinitialise
@Perm(requires="share(cb.array_rows) * immutable(cb.datasizes) * pure(cb.size) * none(cb.plain1) * none(cb.crypt1) * none(cb.plain2) * none(cb.userkey) * none(cb.Z) * none(cb.DK) in ALIVE", ensures= "share(cb.array_rows) * immutable(cb.datasizes) * pure(cb.size) * unique(cb.plain1) * unique(cb.crypt1) * unique(cb.plain2) * unique(cb.userkey) * unique(cb.Z) * unique(cb.DK) in ALIVE")
Method Name = JGFkernel
@Perm(requires="pure(cb.plain1) * share(cb.crypt1) * pure(cb.Z) * share(cb.plain2) * pure(cb.DK) in ALIVE", ensures= "pure(cb.plain1) * share(cb.crypt1) * pure(cb.Z) * share(cb.plain2) * pure(cb.DK) in ALIVE")
Method Name = JGFvalidate
@Perm(requires="pure(cb.array_rows) * pure(cb.plain1) * pure(cb.plain2) * pure(cb.crypt1) in ALIVE", ensures= "pure(cb.array_rows) * pure(cb.plain1) * pure(cb.plain2) * pure(cb.crypt1) in ALIVE")
Method Name = JGFtidyup
@Perm(requires="none(cb.plain1) * none(cb.crypt1) * none(cb.plain2) * none(cb.userkey) * none(cb.Z) * none(cb.DK) in ALIVE", ensures= "unique(cb.plain1) * unique(cb.crypt1) * unique(cb.plain2) * unique(cb.userkey) * unique(cb.Z) * unique(cb.DK) in ALIVE")

//////////////////////////////////////////////////////
Class Name = JGFCryptBench
Method Name = JGFsetsize
Ref-Var= cb.size, Pre-Permissions=share, Post Permissions=share
Method Name = JGFinitialise
Ref-Var= cb.array_rows, Pre-Permissions=share, Post Permissions=share
...
//////////////////////////////////////////////////////
Milli Seconds Time = 1808.153194
*/