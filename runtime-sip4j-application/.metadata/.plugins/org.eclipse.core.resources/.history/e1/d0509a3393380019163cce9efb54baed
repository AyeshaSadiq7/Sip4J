...
public class JGFSparseMatmultBench extends SparseMatmult implements JGFSection2{ 
  ...
  public void JGFinitialise(){
	  ...
	  x = RandomVector(lastElement, R); // here x should be unique as methdo returns a reference Type
 ...
 /* Method Name = JGFrun
  ...
  public void JGFrun(int size){
   ...
   /* Method Name = main
    		...
    		Vertex Name = SPARSE_NUM_ITER, Post Permissions = none, Pre-Permissions =none
    		...
    		Vertex Name = x, Post Permissions = unique, Pre-Permissions =none
    		Vertex Name = datasizes_N, Post Permissions = none, Pre-Permissions =none
    		Vertex Name = R, Post Permissions = none, Pre-Permissions =none
    		Vertex Name = y, Post Permissions = unique, Pre-Permissions =none
    		Vertex Name = datasizes_M, Post Permissions = none, Pre-Permissions =none
    		Vertex Name = val, Post Permissions = unique, Pre-Permissions =none
    		Vertex Name = datasizes_nz, Post Permissions = none, Pre-Permissions =none
    		Vertex Name = col, Post Permissions = unique, Pre-Permissions =none
    		Vertex Name = row, Post Permissions = unique, Pre-Permissions =none
