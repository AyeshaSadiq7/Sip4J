...
public static void main(String[] args) {
		...
		inputFiles.add(testRead("\\Users\\ayeshasadiq\\Documents\\workspace\\runtime-sip4j-application\\pulse-new\\pulseTest.java"));
		//UserSelectedClassesAnalysis.analyzeFromCommandLine(inputFiles, "0","2");
		
		//if (num>=2){
			//seprateJavaFile(args[0]);
			//uma.SMC.UserSelectedClassesAnalysis.analyzeFromCommandLine(inputFiles, args[1],args[2]); 
		//}
	}
