...
public final class Utilities {
  ...
  /**
    ...
    */
  public static String which(String executable, String pathEnv) { // DEBUG = r, className = r, executable = r, pathEnv = r
  ...
  /**
    ...
    */
  public static String joinString(String joinChar,String stringArray[]) { // no permissions are generate for this method
  ...
  /**
    ...
    * @return            A string of the joined string array.
    */
  public static String joinStringOverloaded(String joinChar,String stringArray[],int index) { // none permission generated for this method
  ...
  /**
    ...
    */
  public static String[] splitString(String splitChar,String arg) { // DEBUG = r, className = r
