...
public class ConstantTransferFunction implements ITACBranchSensitiveTransferFunction<TupleLatticeElement<Variable, BooleanConstantLE>> {
	...
	public IResult<TupleLatticeElement<Variable, BooleanConstantLE>> transferOver3(
	...
	@Override
	public IResult<TupleLatticeElement<Variable, BooleanConstantLE>> transferO1(
			CastInstruction instr, List<ILabel> labels,
			TupleLatticeElement<Variable, BooleanConstantLE> value) {
	...
	@Override
	public IResult<TupleLatticeElement<Variable, BooleanConstantLE>> transferOver2(
			ArrayInitInstruction instr, List<ILabel> labels,
			TupleLatticeElement<Variable, BooleanConstantLE> value) {
		// TODO Auto-generated method stub
		return null;
	...
	@Override
	public IResult<TupleLatticeElement<Variable, BooleanConstantLE>> transferOver4(
			BinaryOperation binop, List<ILabel> labels,
			TupleLatticeElement<Variable, BooleanConstantLE> value) {
		// TODO Auto-generated method stub
		return null;
	...
	@Override
	public IResult<TupleLatticeElement<Variable, BooleanConstantLE>> transferOverload4(
			DotClassInstruction instr, List<ILabel> labels,
			TupleLatticeElement<Variable, BooleanConstantLE> value) {
		// TODO Auto-generated method stub
		return null;
