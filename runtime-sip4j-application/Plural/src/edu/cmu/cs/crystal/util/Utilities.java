...
//	}
	...
	public static <T> T nyi() {
		return nyiOverload("This code has not yet been implemented.");
	}
	 ...
	 * given error message.
	 */
	public static <T> T nyiOverload(String err_msg) {
		throw new RuntimeException(err_msg);
	}
	public static void main(String[] args){
		
		md= (MethodDeclaration)getMethodDeclaration(Utilities.node);
		System.out.println(methodDeclarationToString(md));
	}
}
